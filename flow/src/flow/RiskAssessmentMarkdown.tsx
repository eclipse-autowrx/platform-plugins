...
export default function RiskAssessmentMarkdown({ markdownText }: RiskAssessmentMarkdownProps) {
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        h3: ({ children }) => (
          <h3 className="text-xs font-medium text-da-primary-300 pb-1">
            {children}
          </h3>
        ),
        p: ({ children }) => (
          <p className="text-da-gray-dark mb-4">{children}</p>
        ),
        ul: ({ children }) => (
