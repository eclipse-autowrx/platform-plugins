...
- `;
  ...
  function getTableColumns(tableString) {
    if (!tableString || tableString.length < 10)
      return [];
  ...
  function parseCustomerJourneyFull(journeyText) {
    if (!journeyText || journeyText.length < 10)
      return [];
    const columnNames = getTableColumns(journeyText);
    const tableData = parseTableData(journeyText);
    const getCell = (rowName, colName) => tableData.find((r2) => r2.rowName === rowName)?.[colName] ?? "";
  ...
  function parseCustomerJourneySteps(journeyText) {
    if (!journeyText)
      return [];
  ...
  function Page({ data, api }) {
    ...
    const [journeyStepsData, setJourneyStepsData] = (0, import_react12.useState)([]);
    ...
    (0, import_react12.useEffect)(() => {
      if (prototype) {
        ...
        const stepTitles = fullSteps.length > 0 ? fullSteps.map((s) => s.stepTitle) : parseCustomerJourneySteps(prototype.customer_journey);
        try {
          if (prototype.flow) {
    ...
    (0, import_react12.useEffect)(() => {
      ...
      if (flowData.length > 0 && journeyStepsData.length > 0) {
        const synchronized = journeyStepsData.map((j, index2) => {
          const existing = flowData[index2];
          if (existing)
            return { ...existing, title: j.stepTitle };
          ...
          /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "w-full max-w-[120rem] mx-auto min-w-0 self-center", children: [
            ...
            isEditing ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
              ...
              /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("tbody", { children: [
                ...
                flowData?.length > 0 ? flowData.map((step, stepIndex) => {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
                      "td",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "flex flex-col gap-0.5", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { children: step.title }) }),
